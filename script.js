...
window.musicAudioElement = audio;
...
async function heartbeat() {
  ...
  try {
    ...
    // Polling opportuniste : si la session saute, l'appel auth/me recadrera l'UI au prochain refresh.
  }
}
...
async function pollRemoteCommands() {
  ...
  try {
    ...
    // Silencieux pour éviter de spammer l'UI pendant une perte réseau.
  }
}
...
backBtn.addEventListener("click", closeMusic);
